...
def find_eigenvalues(m_val, hat_r_grid, D1_mat, D2_mat, gamma, hat_c0sq, omega_range=(-3, 3), n_scan=800):
...
plt.tight_layout()
plt.savefig('kelvin_modes_variation.pdf', dpi=300)
plt.savefig('kelvin_modes_variation.png', dpi=300)
print("Saved")
